...
ShellRoot {
    ...
    // Font
    property string fontFamily: "@family@"
    property int fontSize: @pointSize@
        ...
        PanelWindow {
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Text {
                        id: clockText
                        text: Qt.formatDateTime(new Date(), Qt.ISODate)
                        color: root.colCyan
                        font.pixelSize: root.fontSize
                        font.family: root.fontFamily
                        font.bold: true
                        ...
                        Timer {
                            ...
                            running: true
                            repeat: true
                            onTriggered: clockText.text = Qt.formatDateTime(new Date(), Qt.ISODate)
                        }
                    }
