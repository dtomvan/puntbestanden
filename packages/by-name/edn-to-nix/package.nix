{ writers }: writers.writeBabashkaBin "edn-to-nix" {} /* clojure */ ''
;; from https://github.com/NixOS/nixpkgs/blob/fffb4e5731497c76bcdc088045c2da810360eae4/pkgs/pkgs-lib/formats/edn/edn_to_nix.clj
(ns edn-to-nix
